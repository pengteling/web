...
$(function()
{
	//$.colorbox({html:"<p style='font-size:14px; line-height:24px; text-indent:24px; background:#fff; border:#000 1px solid; width:150px;'>根据国务院关于推进国有企业改革和国资委关于企业改制的要求，经国机集团批准，机械工业第三设计研究院整体改制更名为国有独资的“中机中联工程有限公司”，目前正在办理更名手续。</p>"});
	$.colorbox({href:"notice.html"});
