...
sql="select n.*,c.catename from "&news_table&" n left join category c on n.cateid=c.cateid where isdel=0"
if cateid<>0 then
	sql=sql & " and n.cateid in (" & sonid & ")"	
end if
if keywords<>"" then
	sql=sql &" and (n.title like '%"&keywords&"%' or n.content like '%"&keywords&"%')"
end if
