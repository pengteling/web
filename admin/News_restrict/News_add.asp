...
If data(3,i)>1 then class_list=class_list& "├"
    ...
    <tr bgcolor="#ECF5FF">
      ...
      <td colspan="2"><input name="Author" type="text" id="auther" value="本站">
...
<textarea name="content" id="editor_id" style="width:700px;height:500px;visibility:hidden;"></textarea>
 <div>
    ...
    <tr>
      ...
      <td height="30" colspan="2" align="left" bgcolor="#ECF5FF"><span class="tr_southidc">
        ...
        <input name="Passed" type="checkbox" id="Passed" value="yes">是<font color="#0000FF">（如果选中的话将直接发布）</font>
      </span></td>
    </tr>
    <tr>
