...
If Act="edit" Then
    ...
    conn.execute("Update category Set content='"&content&"',title='"&title&"' where cateID="&ID)
...
<form id="form1" name="form1" method="post" action="">
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="table_southidc">
    ...
    <tr>
    <td height="25" class="tr_southidc">标题：<input type="text" name="title" style="width:500px;" value="<%=sqlbad(comRs("title"))%>"></td>
    </tr>
    <tr>
