...
<!-- 
   ...
   <!-- <tr bgcolor="#ECF5FF">
      <td height="25" align="center">记录类型：</td>
...
<!--   <tr bgcolor="#ECF5FF">
      <td align="center" height="25" class="tr_southidc">记录价格：</td>
...
document.getElementById("productimages").innerHTML=ImgList;
    ...
    <tr>
      ...
      <td height="30" colspan="2" align="left" bgcolor="#ECF5FF"><input name="Elite" type="checkbox" id="Elite" value="yes">是<font color="#0000FF">（如果选中的话将在首页做为图片记录显示）</font></td>
    </tr>
	<tr>
