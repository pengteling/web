...
fx=ChkFormStr(Request("fx"))
price=alltrim(ChkFormStr(Request("price")))
zx=alltrim(ChkFormStr(Request("zx")))
tel=ChkFormStr(Request("tel"))
area=ChkFormStr(Request("area"))
xmlogo=ChkFormStr(Request("xmlogo"))
hx = strToNum(Request("hx_no1")) &"室" &strToNum(Request("hx_no2")) &"厅"& strToNum(Request("hx_no3")) &"厨"& strToNum(Request("hx_no4")) &"卫"
yt=ChkFormStr(Request("yt"))
...
If lcase(Request("Act"))="add" Then
	Call p_cate(cateid,2)
		...
		sql="select * from product2 where (id is null)"
