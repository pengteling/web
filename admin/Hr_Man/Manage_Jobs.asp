...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="862" align="center" valign="top"> <strong><br>
      </strong> <table width="100%" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
        <tr> 
...
name="cmdcancel">
                ...
                <tr> 
                  <td colspan="2" class="tr_southidc"><div align="center"> 
